(() => {
  ...
  const translations = {
    pt: {
      ...
      "hero.lead": "Desenvolvo projetos web com foco em clareza, utilidade e boa experiência.",
      ...
      "about.eyebrow": "SOBRE",
      "about.heading": "Um pouco sobre como eu trabalho.",
    ...
    en: {
      ...
      "hero.name": "Bruno Cartolano.",
      "hero.lead": "I build web projects focused on clarity, usefulness, and a good user experience.",
      ...
      "about.eyebrow": "ABOUT",
      "about.heading": "A little about how I work.",
    ...
    it: {
      ...
      "hero.name": "Bruno Cartolano.",
      "hero.lead": "Sviluppo progetti web con attenzione alla chiarezza, all’utilità e a una buona esperienza utente.",
      ...
      "about.heading": "Un po’ su come lavoro.",
    ...
    fr: {
      ...
      "hero.name": "Bruno Cartolano.",
      "hero.lead": "Je développe des projets web axés sur la clarté, l’utilité et une bonne expérience utilisateur.",
      ...
      "about.heading": "Un peu sur ma façon de travailler.",
